  ...
  <div class="main">
              ...
              if (have_rows('slider_result_work')):
                ...
                while (have_rows('slider_result_work')) : the_row();
                  ...
                  <?php elseif ($videoUrl) : ?>
                    ...
                    <div class="swiper-slide">
                      <div class="text"><?= $title; ?></div>
                      <div class="before" style="background-color: #0b0b0b; align-self: flex-end; position: relative">
                        <div
                            style="position: absolute; top: 0; left: 0;
                            background: linear-gradient(360deg, #353A42 0%, rgba(53, 58, 66, 0.1) 46.98%, rgba(53, 58, 66, 0.1) 97.73%);
                             height: 100%; width: 100%; z-index: 0">

                        </div>
                        <img src="<?= $vimeoData[0]->thumbnail_large ?>" alt="" style="z-index: 1">
                      </div>
                      <div class="after">
                        <img src="<?= $vimeoData[0]->thumbnail_large ?>" alt="">
                      </div>
                    </div>
                  <?php endif; ?>
                <?php endwhile; ?>
    ...
    <div class="inner">
      <div class="main-6">
        ...
        <div class="callback">
          <a href="javascript:void(0)" class="btn ajax-mfp"
             data-href="<?= get_template_directory_uri() ?>/popup-callback.php">Оставить заявку</a>
